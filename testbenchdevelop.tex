...
\label{ch:testbenchdevelop}
  ...
  configuration are in one file, that is why editing and sharing configurations
  between members of the team is very easy. 
  ...
  \subsection{Teamcity} - is a web-based build management and continuous integration
