...
\label{ch:background} 
  ...
  designed to make creation and maintenance of high quality Web-based user interfaces easy.
   ...
   \item Vaadin brings the power of Java into the Web development. Due to
    ...
    already-made solutions such as building tools Maven and Ant,
    testing tools, frameworks for concurrent
    applications as Akka and other libraries like Yodatime,
     Guava for different stages of development
    process\cite{maven,ant,junit,akka,yodatime,guava}.
  \end{itemize}  		
